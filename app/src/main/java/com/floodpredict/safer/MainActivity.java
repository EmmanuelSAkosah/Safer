package com.floodpredict.safer;
...
public class MainActivity extends AppCompatActivity
    ...
    private Marker currLocation_marker;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (currLocation != null)
            ...
            Location accra_loc = new Location("");
            accra_loc.setLatitude(5.55602);
            accra_loc.setLongitude(-0.1969);
            updateLocationMarker(accra_loc);
        }
    }
    ...
    private void updateLocationMarker(Location location){
        ...
        currLocation_marker = mMap.addMarker(new MarkerOptions().position(latLng)
                .title("Current Position Marker"));
        currLocation_marker.setAlpha(0.7f);
